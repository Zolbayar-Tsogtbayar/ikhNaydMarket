...
export default function BrandsPage() {
  const { brands, products, addBrand, deleteBrand } = useStore();
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
        <h2 className="font-semibold text-slate-800 mb-4">Шинэ брэнд нэмэх</h2>
        {error && (
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          <h2 className="font-semibold text-slate-800">Брэндүүд</h2>
          <span className="text-xs text-slate-400">{brands.length} брэнд</span>
        </div>
